...
export default function LogsPage(): React.ReactElement {
  ...
  const handleDownloadLogs = () => {
    ...
    element.setAttribute('download', `logs_${new Date().toISOString().split('T')[0]}.json`);
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-400">View all security events and threat detections</p>
        </div>
        <button
      ...
      <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search IP, threat, URL..."
              value={filter.search}
