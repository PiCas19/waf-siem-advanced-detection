                    ...
                    <div className="bg-gray-750 p-6 border-b border-gray-700">
                      ...
                      <div className="mt-6 pt-4 border-t border-gray-700 flex gap-3">
                          ...
                          onClick={async () => {
                            try {
                              ...
                              if (response.ok) {
                                ...
                                alert('Failed to report false positive');
                              }
                            } catch (error) {
                              console.error('Error reporting false positive:', error);
                              alert('Error reporting false positive');
                            }
                          }}
                          className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded text-xs font-medium transition"
                        >
                          <AlertTriangle size={14} />
                        ...
                        <button
                            ...
                            try {
                              ...
                              const response = await fetch('/api/blocklist', {
                                ...
                                body: JSON.stringify({
                                  ...
                                  reason: `${log.threat_type} detected on ${log.url}`,
                                  permanent: false,
                                  duration_hours: 24,
                                }),
                              });
                              ...
                              if (response.ok) {
                                alert('IP blocked successfully for 24 hours');
                                setExpandedRow(null);
                              } else {
                          ...
                          className="inline-flex items-center gap-2 px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded text-xs font-medium transition"
                        >
                          <Lock size={14} />
                          Block IP (24h)
                        </button>
